...
function Headerrr() {
  ...
  return (
    <div className=' w-screen flex items-center justify-center h-auto p-2  absolute top-0 left-0'>
 <div className='w-[95%] h-[98%] bg-white/10 backdrop-blur-sm shadow-lg rounded-lg  flex items-center justify-between mx-auto'>
    
        <div className="logo">
           
 <div className='w-[9rem] h-auto p-2'>
  ...
  <g>
    <g id="Layer_1">
      <g id="Layer_1-2" data-name="Layer_1">
        ...
        <div className="extra flex items-center justify-center gap-4 p-1  text-black rounded-lg">
            {/* <div  className="p-2 rounded-md transition duration-300 hover:bg-black hover:text-white">Shop</div> */}

            <a 
  href="https://e-shop.dodge.com" 
  target="_blank" 
  rel="noopener noreferrer"
  className="px-2 lg:px-4 py-2 rounded-md bg-red-600 text-white hover:bg-red-700 transition duration-300 font-mono"
>
  Visit Dodge E-Shop
</a>
